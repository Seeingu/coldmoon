...
func (r *Realm) CreateIntrinsics() {
	...
	r.Intrinsics.BigInt64ArrayPrototype = NewTypedArrayNamePrototype(r, "BigInt64Array")
	r.Intrinsics.BigInt64ArrayConstructor = NewTypedArrayNameConstructor(r, "BigInt64Array")
	r.Intrinsics.BigUint64ArrayPrototype = NewTypedArrayNamePrototype(r, "BigUint64Array")
	r.Intrinsics.BigUint64ArrayConstructor = NewTypedArrayNameConstructor(r, "BigUint64Array")
	r.Intrinsics.Float32ArrayPrototype = NewTypedArrayNamePrototype(r, "Float32Array")
	r.Intrinsics.Float32ArrayConstructor = NewTypedArrayNameConstructor(r, "Float32Array")
	r.Intrinsics.Float64ArrayPrototype = NewTypedArrayNamePrototype(r, "Float64Array")
	r.Intrinsics.Float64ArrayConstructor = NewTypedArrayNameConstructor(r, "Float64Array")
	r.Intrinsics.Int8ArrayPrototype = NewTypedArrayNamePrototype(r, "Int8Array")
	r.Intrinsics.Int8ArrayConstructor = NewTypedArrayNameConstructor(r, "Int8Array")
	r.Intrinsics.Uint8ArrayPrototype = NewTypedArrayNamePrototype(r, "Uint8Array")
	r.Intrinsics.Uint8ArrayConstructor = NewTypedArrayNameConstructor(r, "Uint8Array")
	r.Intrinsics.Uint8ClampedArrayPrototype = NewTypedArrayNamePrototype(r, "Uint8ClampedArray")
	r.Intrinsics.Uint8ClampedArrayConstructor = NewTypedArrayNameConstructor(r, "Uint8ClampedArray")
	r.Intrinsics.Int16ArrayPrototype = NewTypedArrayNamePrototype(r, "Int16Array")
	r.Intrinsics.Int16ArrayConstructor = NewTypedArrayNameConstructor(r, "Int16Array")
	r.Intrinsics.Uint16ArrayPrototype = NewTypedArrayNamePrototype(r, "Uint16Array")
	r.Intrinsics.Uint16ArrayConstructor = NewTypedArrayNameConstructor(r, "Uint16Array")
	r.Intrinsics.Int32ArrayPrototype = NewTypedArrayNamePrototype(r, "Int32Array")
	r.Intrinsics.Int32ArrayConstructor = NewTypedArrayNameConstructor(r, "Int32Array")
	r.Intrinsics.Uint32ArrayPrototype = NewTypedArrayNamePrototype(r, "Uint32Array")
	r.Intrinsics.Uint32ArrayConstructor = NewTypedArrayNameConstructor(r, "Uint32Array")
